    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 pb-16">
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-lg sm:text-xl text-sand mb-8 max-w-2xl mx-auto font-medium">
          Your Modern Islamic Digital Companion
        </p>

        <p className="text-base sm:text-lg text-white/80 mb-12 max-w-xl mx-auto leading-relaxed">
          Experience the beauty of Islamic learning through a modern, elegant platform.
          Connect with Quran recitations, live radio, divine tafsir, and accurate prayer times — all in one place.
        </p>
